...
struct TraceStats {
    ...
    token_count: Option<christina_core::types::TokenCount>,
    ...
    max_input_tokens: Option<christina_core::types::TokenCount>,
    max_output_tokens: Option<christina_core::types::TokenCount>,
